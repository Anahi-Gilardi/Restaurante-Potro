...
def page_admin_menu_diario() -> None:
    ...
    for col, (d_key, d_label) in zip(cols_days, DIAS_SEMANA):
        ...
        with col:
            ...
            if st.button(f"Editar {d_label}", key=f"btn_strip_root_{d_key}", use_container_width=True):
