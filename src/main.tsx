  ...
  if (event.reason?.message?.includes('Failed to fetch dynamically imported module') ||
    ...
    forceCleanReload().then(success => {
      if (!success) {
        ...
        overlay.style.cssText = 'position:fixed;top:0;left:0;width:100%;height:100%;background:#FAF7F0;color:#DB9C60;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:2rem;text-align:center;font-family:sans-serif;z-index:99999;border:4px solid #C8956A';
        overlay.innerHTML = `
          <div style="max-width:500px;background:#fff;padding:2rem;border-radius:24px;box-shadow:0 10px 25px -5px rgba(0,0,0,0.1);border:1px solid rgba(74,45,27,0.1)">
            ...
            <h2 style="margin-bottom:0.75rem;font-weight:900;font-family:Cinzel,serif;color:#DB9C60">Actualización Pendiente</h2>
            ...
            <button onclick="window.location.reload(true)" style="background:#DB9C60;color:#1A110B;border:none;padding:0.75rem 1.75rem;border-radius:12px;font-weight:bold;cursor:pointer;font-size:13px;box-shadow:0 4px 6px -1px rgba(74,45,27,0.2);transition:all 0.2s">
