          ...
          <form onSubmit={handleCreateItem} className="space-y-3">
            <div>
              ...
              <input 
                ...
                className="w-full min-h-11 text-sm p-2.5 rounded-xl border border-stone-200 bg-stone-50/50 focus:outline-none focus:ring-1 focus:ring-[#624A3E]"
                required
              />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea 
                ...
                rows={2}
                className="w-full text-sm p-2.5 rounded-xl border border-stone-200 bg-stone-50/50 focus:outline-none focus:ring-1 focus:ring-[#624A3E] resize-none"
              />
            </div>
            <div>
              ...
              <select 
                ...
                className="w-full min-h-11 text-sm p-2.5 rounded-xl border border-stone-200 bg-stone-50/50 focus:outline-none focus:ring-1 focus:ring-[#624A3E] cursor-pointer font-bold text-stone-700"
              >
            ...
            <button 
              type="submit"
              className="w-full min-h-11 py-2.5 bg-[#624A3E] hover:bg-[#503C32] text-white text-xs font-extrabold rounded-xl transition-all shadow-md shadow-[#624A3E]/10 cursor-pointer"
            >
              Registrar en Carta
            </button>
          </form>
        ...
        <div className="bg-white p-4 sm:p-6 rounded-2xl border border-stone-200 shadow-xs lg:col-span-3 space-y-4">
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="w-full min-h-11 text-sm pl-9 pr-4 py-3 rounded-xl border border-stone-200 bg-stone-50/50 focus:outline-none focus:ring-1 focus:ring-[#624A3E]"
            />
          </div>
                ...
                <div className="flex-1 flex flex-col justify-between min-w-0">
                      ...
                      <div className="space-y-2 mt-1">
                        ...
                        <div className="flex gap-1.5">
                          <button onClick={() => handleSaveEdit(item.id_producto)}
                            className="p-1.5 rounded bg-[#22C55E]/15 hover:bg-[#22C55E]/20 text-[#22C55E] cursor-pointer"><Check className="w-3.5 h-3.5" /></button>
                          <button onClick={() => setEditingId(null)}
                            className="p-1.5 rounded bg-stone-100 hover:bg-stone-200 text-stone-500 cursor-pointer"><X className="w-3.5 h-3.5" /></button>
                        </div>
                      </div>
                    ) : (
                      <div className="flex items-center gap-1.5">
                        ...
                        <button onClick={() => handleStartEditing(item)}
                          className="p-1.5 px-2 rounded hover:bg-stone-200/50 text-stone-400 hover:text-stone-750 transition-colors cursor-pointer text-[10px]">
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-stone-200/40 mt-1">
                    <button onClick={() => handleDuplicateItem(item)}
                      className="text-[9px] sm:text-[10px] font-bold px-2 py-1 rounded cursor-pointer transition-colors bg-stone-50 hover:bg-stone-100 text-stone-500 flex items-center gap-1">
                    ...
                    <button 
                      ...
                      className={`text-[9px] sm:text-[10px] font-black px-2 py-1 rounded cursor-pointer transition-colors ${
                        item.activo 
