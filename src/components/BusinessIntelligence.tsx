    ...
    <div className="space-y-4 md:space-y-6" id="bi-analytics-container">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-white border border-stone-200/80 border-l-4 border-l-[#624A3E]/90 rounded-2xl p-4 shadow-sm flex items-center justify-between">
          <div className="min-w-0">
            ...
            <h4 className="text-xl md:text-2xl font-black text-stone-900 font-mono mt-1">{tiempoPromedio} min</h4>
        ...
        <div className="bg-white border border-stone-200/80 border-l-4 border-l-[#22C55E] rounded-2xl p-4 shadow-sm flex items-center justify-between">
          <div className="min-w-0">
            ...
            <h4 className="text-xl md:text-2xl font-black text-stone-900 font-mono mt-1">{efectividad}{efectividadReal ? '%' : ''}</h4>
            <p className="text-[9px] text-stone-500 mt-1.5 font-sans leading-tight">
              Despachos antes de semáforo rojo
            </p>
          </div>
          <div className="w-10 h-10 bg-[#22C55E] text-white rounded-xl flex items-center justify-center shadow-md shadow-emerald-500/10 shrink-0">
        ...
        <div className="bg-white border border-stone-200/80 border-l-4 border-l-[#EF4444] rounded-2xl p-4 shadow-sm flex items-center justify-between">
          <div className="min-w-0">
            ...
            <h4 className="text-xl md:text-2xl font-black text-stone-900 font-mono mt-1">
        ...
        <div className="bg-white border border-stone-200/80 border-l-4 border-l-[#F97316] rounded-2xl p-4 shadow-sm flex items-center justify-between">
          <div className="min-w-0">
            ...
            <h4 className="text-xl md:text-2xl font-black text-[#624A3E] font-mono mt-1">En Línea</h4>
            <p className="text-[9px] text-[#F97316] mt-1.5 font-sans font-bold">
              Rappi & PedidosYa integrados
            </p>
          </div>
          <div className="w-10 h-10 bg-[#1E1E1E] text-white rounded-xl flex items-center justify-center shadow-md shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
          ...
          <div className='bg-white rounded-2xl p-4 sm:p-5 border border-stone-200 shadow-sm'>
            <div className='flex items-center gap-2 mb-4 pb-3 border-b border-slate-50'>
              ...
              <div className="min-w-0">
                ...
                <p className='text-[10px] sm:text-[11px] text-slate-400'>Calculado desde pedidos cobrados en tiempo real</p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 sm:p-6 space-y-4">
          <div className="flex flex-col sm:flex-row justify-between items-start gap-3 pb-2 border-b border-slate-50">
            <div className="min-w-0">
              <h4 className="font-extrabold text-sm text-slate-800 font-sans tracking-tight flex items-center gap-2">
                <Compass className="w-4.5 h-4.5 text-slate-600 shrink-0" />
                Matriz BCG Comercial del Menú
              </h4>
              <p className="text-[10px] sm:text-[11px] text-slate-400">
                Segmentación estratégica demanda vs rentabilidad.
              </p>
            </div>
            <span className="text-[9px] font-mono bg-slate-100 text-slate-700 font-bold px-2 py-0.5 rounded shrink-0">
              Matriz 2x2
            </span>
          </div>

          {/* Core BCG Canvas drawing */}
          <div className="relative bg-slate-50 border border-slate-100 rounded-xl aspect-[1.6/1] sm:aspect-[1.8/1] overflow-hidden p-3 mt-4">
            ...
            <div className="absolute inset-0 grid grid-cols-2 grid-rows-2">
              ...
              <div className="border-r border-b border-dashed border-slate-205 flex items-start p-1 sm:p-2">
                <span className="text-[8px] sm:text-[10px] font-extrabold text-purple-700 bg-purple-50 px-1 py-0.5 rounded font-sans uppercase">INCÓGNITA</span>
              </div>
              {/* Top Right: Stars */}
              <div className="border-b border-dashed border-slate-205 flex items-start justify-end p-1 sm:p-2">
                <span className="text-[8px] sm:text-[10px] font-extrabold text-blue-700 bg-blue-50 px-1 py-0.5 rounded font-sans uppercase">ESTRELLA</span>
              </div>
              {/* Bottom Left: Dogs */}
              <div className="border-r border-dashed border-slate-205 flex items-end p-1 sm:p-2">
                <span className="text-[8px] sm:text-[10px] font-extrabold text-slate-500 bg-slate-200/50 px-1 py-0.5 rounded font-sans uppercase">PERRO</span>
              </div>
              {/* Bottom Right: Cash Cows */}
              <div className="flex items-end justify-end p-1 sm:p-2">
                <span className="text-[8px] sm:text-[10px] font-extrabold text-emerald-700 bg-emerald-50 px-1 py-0.5 rounded font-sans uppercase">VACA SAGRADA</span>
              </div>
            </div>
            ...
            {bcgData.map((item, idx) => {
              return (
                ...
                >
                  ...
                  <div className={`w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full ${item.color} cursor-pointer border border-white ring-2 ring-slate-900/10 hover:scale-125 transition-transform`} />

                  {/* Hover tooltip */}
                  <div className="pointer-events-none absolute bottom-4 left-1/2 -translate-x-1/2 bg-slate-900 text-white rounded-lg p-2.5 w-36 sm:w-44 shadow-lg z-20 text-[9px] sm:text-[10px] space-y-1 opacity-0 group-hover:opacity-100 transition-opacity whitespace-pre-wrap font-sans">
          ...
          <div className="bg-slate-50 rounded-xl p-3 border border-slate-100 text-[10px] sm:text-[11px] text-slate-500 flex items-start gap-1.5 leading-snug">
            <Info className="w-4 h-4 text-slate-400 shrink-0" />
            <span>Pase el cursor por encima de los puntos para ver recomendaciones comerciales.</span>
          </div>
        </div>

        {/* DEMORAS PROMEDIO BAR CHART */}
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 sm:p-6 space-y-4">
          <div className="flex flex-col sm:flex-row justify-between items-start gap-3 pb-2 border-b border-slate-50 font-sans">
            <div className="min-w-0">
              <h4 className="font-extrabold text-sm text-slate-800 tracking-tight flex items-center gap-2">
                <BarChart3 className="w-4.5 h-4.5 text-slate-600 shrink-0" />
          ...
          <div className="relative pt-4 sm:pt-6 h-56 sm:h-64 flex flex-col justify-end">
            <div className="flex items-end justify-between h-40 sm:h-44 border-b border-slate-100 px-2 sm:px-4">
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 sm:p-6 space-y-4">
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 border-b border-slate-50 pb-4 font-sans">
          <div className="min-w-0">
            <h4 className="font-bold text-sm text-slate-800 tracking-tight flex items-center gap-2">
              <Activity className="w-4.5 h-4.5 text-slate-600 shrink-0" />
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="w-full min-h-11 pl-8 pr-3 py-1.5 bg-slate-50 rounded-lg text-xs text-slate-700 focus:outline-none placeholder-slate-400 border border-slate-100 focus:border-slate-300"
              />
            </div>

            <div className="flex bg-slate-50 p-0.5 rounded-lg border border-slate-100 overflow-x-auto">
              {(['todo', 'pedidos', 'stock', 'alertas'] as const).map(fl => (
                <button
                  key={fl}
                  onClick={() => setLogFilter(fl)}
                  className={`text-[9px] sm:text-[10px] font-bold px-2 sm:px-3 py-1.5 rounded-md capitalize transition-colors whitespace-nowrap ${
                    logFilter === fl
        ...
        <div className="bg-slate-900 rounded-xl p-3 sm:p-4 font-mono text-[11px] leading-relaxed text-slate-300 h-64 overflow-y-auto border border-slate-950 space-y-2 select-all shadow-inner custom-scrollbar">
            ...
            filteredLogs.slice().reverse().map(l => {
              ...
              return (
                <div key={l.id} className="hover:bg-slate-800/60 p-1.5 rounded transition-colors flex items-start gap-2.5">
                  ...
                  <span className="text-slate-200 text-[10px] sm:text-[11px]">{l.mensaje}</span>
                </div>
              );
            })
          )}
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 text-[10px] text-slate-400 font-mono">
