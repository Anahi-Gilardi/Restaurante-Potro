...
export default function PythonStreamlitLogin({ onLoginSuccess, onBackToCover }: PythonStreamlitLoginProps) {
  ...
  return (
    <div className="min-h-screen bg-[#F5F1E9] text-stone-850 font-sans flex items-center justify-center p-4 relative overflow-hidden" id="pos-login-container">
      ...
      <div className="absolute bottom-[-25%] right-[-10%] w-[60%] h-[60%] rounded-full bg-[#DB9C60]/5 blur-3xl" />
      ...
      <div className="max-w-md w-full bg-[#FFFDF8] rounded-3xl border border-stone-150 shadow-xl shadow-stone-200/40 p-6 sm:p-8 md:p-10 space-y-8 relative z-10">
        ...
        <div className="text-center space-y-4 flex flex-col items-center">
          ...
          <div className="space-y-1">
            <h1 className="text-2xl font-bold text-[#DB9C60] tracking-wide font-serif-rustic">El Patrón Pro</h1>
        ...
        {isLoggingIn ? (
          <div className="py-12 flex flex-col items-center justify-center space-y-4 animate-fadeIn" aria-live="polite">
            <Loader2 className="w-10 h-10 text-[#DB9C60] animate-spin" />
          ...
          <form className="space-y-4 pt-2" onSubmit={handleLogin}>
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full py-3 pl-10 pr-4 bg-stone-50 border border-stone-200 rounded-xl text-sm text-stone-800 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-[#DB9C60]/20 focus:border-[#DB9C60] transition-all"
                  autoFocus
                />
              </div>
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full py-3 pl-10 pr-10 bg-stone-50 border border-stone-200 rounded-xl text-sm text-stone-800 placeholder:text-stone-400 focus:outline-none focus:ring-2 focus:ring-[#DB9C60]/20 focus:border-[#DB9C60] transition-all"
                />
                <button
                  type="button"
            ...
            <button
              ...
              className="w-full py-4 px-4 bg-[#DB9C60] hover:bg-[#B97F47] disabled:opacity-60 disabled:cursor-not-allowed active:scale-[0.98] text-stone-950 font-extrabold rounded-xl text-sm uppercase tracking-wider flex items-center justify-center gap-2 transition-all cursor-pointer shadow-md shadow-[#DB9C60]/10"
            >
            ...
            <div className="pt-2 text-center space-y-3">
              <button
                ...
                className="text-xs font-semibold text-stone-500 hover:text-[#DB9C60] hover:underline transition-all cursor-pointer flex items-center justify-center gap-1 mx-auto"
              >
              ...
              {onBackToCover && (
                <button
                  type="button"
                  onClick={onBackToCover}
                  className="text-xs font-bold text-[#DB9C60] hover:text-[#9B2226] hover:underline transition-all cursor-pointer flex items-center justify-center gap-1 mx-auto font-display-serif"
                >
