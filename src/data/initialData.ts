...
export const INITIAL_PRODUCTOS_MENU: ProductoMenu[] = [
  ...
  // Salentein
  {
    ...
    descripcion: 'Bodega Salentein. Blanco java, fresco y muy expresivo en aromas.',
  ...
  },
  {
    ...
    descripcion: 'Valle de Pedernal. Intenso, especiado, con taninos firmes and elegantes.',
    precio_venta: 21500.00,
    categoria: 'Bodega',
    subcategoria: 'Vinos tintos',
    activo: true,
